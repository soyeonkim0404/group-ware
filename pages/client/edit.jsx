...
import { apiEditClient, parallelApi } from '@api';
...
const Edit = ({ businessTypes, detail }) => {
  ...
  const [bankList, setBankList] = useState(
    detail.bank?.map((item) => ({ ...item, key: uuidv4() })) || []
  );
  const [staffList, setStaffList] = useState(
    detail.staff?.map((item) => ({ ...item, key: uuidv4() })) || []
  );
  ...
  const addBank = (e) => {
    setBankList((prevState) => [
      { key: uuidv4(), id: null, bankCode: '', bankName: '', account: '', name: '' },
      ...prevState,
    ]);
  };
              ...
              <SFormList>
                <li>
                  <FormSelect
                    ...
                    label="사업 유형"
                    defaultValue={detail.businessTypeCode}
                    error={errorMsg}
                    required={true}
                  />
                </li>
                <li>
                  <FormInput
                    ...
                    length={85}
                    max={255}
                    defaultValue={detail.companyNameKr}
                    error={errorMsg}
                    required={true}
                  />
                </li>
                <li>
                  <FormInput
                    ...
                    length={85}
                    max={255}
                    defaultValue={detail.companyNameEn}
                    error={errorMsg}
                  />
                </li>
                <li>
              ...
              <SFormList>
                ...
                <li className="width-half">
                  <FormInput
                    ...
                    length={85}
                    max={255}
                    defaultValue={detail.mainBusiness}
                    error={errorMsg}
                  />
                </li>
              </SFormList>
              <SFormList>
                ...
                <li className="width-half">
                  <FormInput
                    ...
                    label="상세 주소"
                    length={333}
                    defaultValue={detail.detailAddress}
                    error={errorMsg}
                  />
                </li>
              </SFormList>
              <SFileLoad>
                <FileUpload fileData={(data) => setFiles(data)} defaultValue={files} />
              </SFileLoad>
            </Card.Body>
          </Card>
...
export const getServerSideProps = withGetServerSideProps(async (context) => {
  ...
  const parallelData = [
    ...
    {
      name: 'detail',
      url: `/api/v1/client/select?id=${id}`,
      method: 'get',
    },
  ];
  ...
  return {
    props: { businessTypes: response['businessTypes'], detail: response['detail'] },
  };
});
